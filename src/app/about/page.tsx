  ...
  return (
    <div className="pt-20">
      ...
      <AnimatedSection animation="scale-in">
        <section className="px-5 sm:px-6 lg:px-10 mb-24">
      ...
      <section className="py-16 sm:py-20 lg:py-32 bg-gray-50">
        <div className="max-w-[1400px] mx-auto px-5 sm:px-6 lg:px-10">
          <div className="grid md:grid-cols-2 gap-10 sm:gap-16 md:gap-24">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <AnimatedSection key={i} delay={i * 100}>
                <div className="border border-white/10 p-6 sm:p-8 hover:border-white/30 transition-colors duration-300">
        ...
        <div className="max-w-2xl mx-auto px-5 sm:px-6">
          <AnimatedSection>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/shop"
                className="px-7 sm:px-10 py-4 bg-black text-white text-sm tracking-[0.2em] uppercase hover:bg-gray-900 transition-colors"
              >
                Shop Circle
              </Link>
              <Link
                href="/contact"
                className="px-7 sm:px-10 py-4 border border-black text-sm tracking-[0.2em] uppercase hover:bg-black hover:text-white transition-colors"
              >
                Get in Touch
              </Link>
            </div>
