...
import { brandPrinciples } from '@/data/testimonials';
            ...
            <div>
              <AnimatedSection delay={0}>
                <p className="text-xs tracking-[0.3em] uppercase text-black/40 mb-6">
                  Premium Merchandise for Everyday Pride
                </p>
              </AnimatedSection>
              ...
              <AnimatedSection delay={200}>
                <p className="text-lg text-black/50 font-light max-w-md mb-10 leading-relaxed">
                  Circle is a merchandise brand and store for people who want what they wear
                  to feel like identity, belonging, and a quiet statement of pride.
                </p>
              </AnimatedSection>
              ...
              <div className="relative grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="aspect-[3/4] bg-gray-50 overflow-hidden img-zoom">
                    <img
                      src="https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=500&h=660&fit=crop&q=80"
                      alt="Premium streetwear styling"
                ...
                <div className="space-y-4 pt-12">
                  <div className="aspect-square bg-gray-50 overflow-hidden img-zoom">
                    <img
                      src="https://images.unsplash.com/photo-1529139574466-a303027c1d8b?w=500&h=500&fit=crop&q=80"
                      alt="Modern fashion detail"
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <div className="aspect-[3/4] bg-gray-50 overflow-hidden img-zoom">
                    <img
                      src="https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=500&h=660&fit=crop&q=80"
                      alt="Premium hoodie"
                      className="w-full h-full object-cover"
                    />
                  </div>
        ...
        <div className="marquee-track">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="flex items-center gap-12 px-6">
              {['Premium Quality', 'Everyday Pride', 'Custom Branding', 'Circle Store', 'Limited Drops', 'Clean Design', 'Bulk Orders', 'Made to Belong'].map((text, j) => (
            ...
            {[
              {
                ...
                desc: 'Shop ready-to-wear essentials or tell us about the identity, event, team, or community you want to bring to life.',
              },
              {
                step: '02',
                title: 'We Shape the Merchandise',
                desc: 'We focus on clean design, usable products, and details that make the piece feel worth wearing beyond a single occasion.',
              },
              {
                step: '03',
                title: 'Wear It With Pride',
                desc: 'Circle pieces are made to travel with people — from everyday routines to moments that make a group feel connected.',
              },
            ].map((item, i) => (
          ...
          <AnimatedSection animation="slide-right">
            <div className="max-w-lg">
              ...
              <h2 className="text-3xl md:text-4xl font-light tracking-tight mb-6">
                Premium Pieces,<br />Thoughtfully Branded
              </h2>
              <p className="text-black/50 font-light leading-relaxed mb-8">
                From everyday tees to hoodies, caps, bottles, and bags — Circle helps teams,
                creators, communities, and campuses create merchandise people actually want to keep wearing.
              </p>
              <Link
                href="/b2b"
        ...
        <div className="relative bg-black text-white py-24 px-6 lg:px-16 flex items-center">
          <AnimatedSection animation="slide-left">
            <div className="max-w-lg">
              ...
              <h2 className="text-3xl md:text-4xl font-light tracking-tight mb-6">
                A Storefront for<br />Your Circle
              </h2>
              <p className="text-white/50 font-light leading-relaxed mb-8">
                For groups that need more than a one-time order, Circle can support a clean digital
                storefront, drop announcements, and simple merchandise discovery in one place.
              </p>
              <Link
                href="/app-solution"
            ...
            {brandPrinciples.map((principle, i) => (
              <AnimatedSection key={principle.id} delay={i * 100}>
                <div className="border border-gray-100 p-8 hover:border-gray-300 transition-colors duration-300 h-full flex flex-col">
                  ...
                  <h3 className="text-xl font-light mb-4">{principle.title}</h3>
                  <p className="text-sm text-black/50 font-light leading-relaxed flex-1">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <AnimatedSection animation="slide-left">
              <div>
                ...
                <h2 className="text-3xl md:text-4xl font-light tracking-tight mb-6">
                  Circle = Identity You Carry
                </h2>
                <p className="text-black/50 font-light leading-relaxed mb-6">
                  Circle is built on a simple belief: merchandise should feel personal. A hoodie,
                  tee, cap, or bag can become a reminder of the people, places, and ideas someone is proud to carry.
                </p>
                <p className="text-black/50 font-light leading-relaxed mb-8">
                  Colleges can be part of that story, but Circle is not only for colleges. It is for anyone
                  building a community, a brand, an event, or a shared identity that deserves to be worn well.
                </p>
                <Link
                  href="/about"
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { name: 'Caps', image: 'https://images.unsplash.com/photo-1588850561407-ed78c334e67a?w=400&h=500&fit=crop&q=80' },
              { name: 'Bags', image: 'https://images.unsplash.com/photo-1590874103328-eac38a683ce7?w=400&h=500&fit=crop&q=80' },
            ].map((cat, i) => (
